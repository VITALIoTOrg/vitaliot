module.exports = function (RED) {
    ...
    function QuerySensors(config) {
        ...
        this.on('input', function (msg) {
            ...
            var secreq = ((/^https/.test(securl)) ? https : http).request(secopts, function (secres) {
                ...
                var dmsurl = RED.settings.dms.url + '/querySensor';
                ...
                dmsreq.on('error', function (err) {
                    msg.payload = 'Failed to query sensors (' + err.toString() + ').';
    ...
    RED.nodes.registerType('query sensors', QuerySensors);
}
