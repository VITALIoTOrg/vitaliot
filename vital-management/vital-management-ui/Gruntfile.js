...
module.exports = function(grunt) {
    ...
    grunt.initConfig({
        ...
        less: {
            ...
            build: {
                files: {
                    './target/build/vital-management.css': './src/main/javascript/less/main.less'
                }
            }
        },
        ...
        jshint: {
            ...
            all: [
                './src/main/javascript/{app,origination}/**/*.js',
                './src/main/javascript/{app,origination}/**/*.spec.js',
                './src/main/javascript/{app,origination}/**/*.mock.js'
            ],
            test: {
                src: [
                    './src/main/javascript/{app,origination}/**/*.spec.js',
