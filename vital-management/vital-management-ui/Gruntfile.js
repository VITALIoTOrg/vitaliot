module.exports = function(grunt) {
    ...
    grunt.initConfig({
         ...
         */
        src_folder: 'src/main/javascript',
        ...
        vendor_files: {
            js: [
                ...
                '<%= vendor_folder %>/gsap/src/uncompressed/TweenMax.js',
                '<%= vendor_folder %>/leaflet/dist/leaflet-src.js',
                '<%= vendor_folder %>/Leaflet.awesome-markers/dist/leaflet.awesome-markers.js',
                '<%= vendor_folder %>/leaflet.markercluster/dist/leaflet.markercluster-src.js',
                '<%= vendor_folder %>/raphael/raphael.js',
                '<%= vendor_folder %>/morrisjs/morris.js',
                '<%= vendor_folder %>/admin-lte/js/AdminLTE/app.js',
                ...
                '<%= vendor_folder %>/angular-animate/angular-animate.js',
                '<%= vendor_folder %>/angular-sanitize/angular-sanitize.js',
                '<%= vendor_folder %>/angular-translate/angular-translate.js',
                '<%= vendor_folder %>/angular-translate-loader-static-files/angular-translate-loader-static-files.js',
                '<%= vendor_folder %>/angular-translate-storage-cookie/angular-translate-storage-cookie.js',
                '<%= vendor_folder %>/angular-leaflet-directive/dist/angular-leaflet-directive.js',
                '<%= vendor_folder %>/ngFx/dist/ngFx.js'
            ],

            css: [
                '<%= vendor_folder %>/leaflet/dist/leaflet.css',
                '<%= vendor_folder %>/Leaflet.awesome-markers/dist/leaflet.awesome-markers.css',
                '<%= vendor_folder %>/leaflet.markercluster/dist/MarkerCluster.Default.css'
            ],
            assets_fonts: [
                '<%= vendor_folder %>/admin-lte/fonts/*',
                '<%= vendor_folder %>/fontawesome/fonts/*'
            ],

            assets_images: [
                '<%= vendor_folder %>/leaflet/dist/images/*',
                '<%= vendor_folder %>/Leaflet.awesome-markers/dist/images/*',
                '<%= vendor_folder %>/admin-lte/img/*'
            ]
        },
        test_files: {
            js: [
                ...
                proxies: [
                    {
                        ...
                        https: false,
                        // Change these to match setup
                        host: 'localhost',
                        port: 8080,
                        headers: {
                            //'host': 'vital2.cloud.reply.eu'
                            'host': 'localhost'
                        }
                    }
                ]
