...
public class Subject_ {
    ...
    public Subject_ withType(String type) {
        this.type = type;
        return this;
    }
    ...
    public Subject_ withAdditionalProperty(String name, Object value) {
        this.additionalProperties.put(name, value);
        return this;
    }
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof Subject_) == false) {
            return false;
        }
        Subject_ rhs = ((Subject_) other);
