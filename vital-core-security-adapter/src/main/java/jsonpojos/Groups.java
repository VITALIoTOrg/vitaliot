...
public class Groups {
    ...
    public Groups withResult(List<String> result) {
        this.result = result;
        return this;
    }
    ...
    public Groups withResultCount(Integer resultCount) {
        this.resultCount = resultCount;
        return this;
    }
    ...
    public Groups withPagedResultsCookie(Object pagedResultsCookie) {
        this.pagedResultsCookie = pagedResultsCookie;
        return this;
    }
    ...
    public Groups withRemainingPagedResults(Integer remainingPagedResults) {
        this.remainingPagedResults = remainingPagedResults;
        return this;
    }
