package eu.vital.orchestrator.security;
...
public class SecurityService {
	...
	public URL getSecurityProxyUrl() {
		try {
			return new URL(vitalConfiguration.getProperty("vital-core-orchestrator.security", "https://localhost:8080/securitywrapper/rest"));
		} catch (MalformedURLException e) {
			log.warning("vital-core-orchestrator.security is malformed" + vitalConfiguration.getProperty("vital-core-orchestrator.security"));
			return null;
		}
	}
	...
	public String getSystemAuthenticationToken() {
		...
		String user = vitalConfiguration.getProperty("vital-core-orchestrator.system.user", "manplatform");
		String password = vitalConfiguration.getProperty("vital-core-orchestrator.system.password", "password");
