...
angular.module('common.authentication', [])
    ...
    .provider('authentication', [
        function () {
            var provider = this;
            provider.$get = [
                '$window', '$http', '$q', '$location', '$cookies', '$timeout', 'SERVICE_URL',
                function ($window, $http, $q, $location, $cookies, $timeout, SERVICE_URL) {
                    var service = {
                        ...
                        fetchLoggedOnUser: function () {
                            if (service.isAuthenticated()) {
                                ...
                                return $http.get(SERVICE_URL + '/authentication/logged-on')
                                    .then(function (resp) {
                        ...
                        login: function (loginData) {
                            return $http({
                                method: 'POST',
                                url: SERVICE_URL + '/authentication/login',
                        ...
                        logout: function () {
                            ...
                            return $http({
                                method: 'POST',
                                url: SERVICE_URL + '/authentication/logout',
                                withCredentials: true,
                                data: '',
                                headers: {'Content-Type': 'application/x-www-form-urlencoded'}
